...
public struct ProductDetailView: View {
    ...
    public init(container: DIContainer, product: Product) {
        _viewModel = ObservedObject(wrappedValue: ProductDetailViewModel(product: product,
                                                                         domain: container.makeDomain()))
    }
